...
export interface ErrorLog {
  id: string;
  timestamp: string;
  type: 'angular' | 'javascript' | 'federation' | 'network' | 'other';
  message: string;
  stackTrace?: string;
...
export class ErrorLoggingService {
  ...
  private readonly STORAGE_KEY = 'meme-generator-error-logs';
  ...
  downloadLogs(): void {
    ...
    a.href = url;
    a.download = `meme-generator-logs-${new Date().toISOString()}.json`;
